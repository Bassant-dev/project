...
{
  String ?uId;
  classicScreen({ required this.uId});
...
//scrollDirection: Axis.vertical,
                        ...
                        itemCount: cubit.products_classic.length,itemBuilder:(context,index){
                          return Container(
                              ...
                              children: [
                                ...
                                InkWell(
                                  ...
                                  child: Container(
                                      ...
                                      child:CircleAvatar(
                                        radius: 52,
                                        backgroundImage:AssetImage(cubit.products_classic[index].image,),
                                ...
                                Row(
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      alignment: Alignment.centerLeft,child: Text( cubit.products_classic[index].name,style: TextStyle(fontSize: 18,color: Colors.black,fontWeight: FontWeight.bold),),

                                    ),
                                    SizedBox(width:40,),
                                    InkWell(
                                        child:
                                        cubit.products_classic[index].fav?
                                        ...
                                        onTap: ()
                                        {
                                          ...
                                          cubit.isFavorites(cubit.products_classic[index],uid,cubit.products_classic[index].name);
                                ...
                                Container(
                                    ...
                                    child: Text(cubit.products_classic[index].discription,style: TextStyle(fontSize: 15,color: Colors.grey,),maxLines: 1,
                                    )
                                ),
                                SizedBox(height: 8,),
                                Container(
